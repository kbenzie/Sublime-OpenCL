...
The python script 'install.py' (requires Python 2.x) is the easiest method of installing the package from source. Simply run the script and it will search for the correct directory to install the package. If there are any problems please create an issue, if it has not already been added, to the issue tracker.
...
* OpenCL C/C++ API snippets and completions
* Requests for improvements are welcome and can be posted in the issue tracker
